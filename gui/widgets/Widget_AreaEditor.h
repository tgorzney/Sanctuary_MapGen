...
namespace SanmapGen {
    ...
    public:
        static void RenderOverlay(GenerationParams& params, ImVec2 p0, ImVec2 p1, ImVec2 uv0, ImVec2 uv1, float renderSize, float mapZoom, ImVec2 mapOffset, bool& bNeedsPreviewRender);
    };
}
