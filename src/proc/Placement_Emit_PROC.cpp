...
void PlacementStage::EmitInstance(std::size_t configurationIndex, const SymmetryOrbitPoint& point,
    ...
    if ((configuration.selectionFlags & ScatterSelectionFlag::AlignToNormal) != 0) {
        ...
        const float heightScale = recipe.geometry.terrainMaxHeight / recipe.geometry.worldUnitsPerGenerationCell;
    ...
    instance.positionX = point.positionX * recipe.geometry.worldUnitsPerGenerationCell;
    instance.positionZ = point.positionY * recipe.geometry.worldUnitsPerGenerationCell;
