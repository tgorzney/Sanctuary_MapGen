...
// Noise/Blend -> Mask -> Erosion -> Thermal -> Flow/Accumulation -> Placement -> Bake, each
// registered with its own ComputeParameterHash (what makes it dirty) and its Run (which
